...
func (x *IpInfoResp) Reset() {
	*x = IpInfoResp{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proxy_v1_ip_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*IpInfoResp) Descriptor() ([]byte, []int) {
	return file_proxy_v1_ip_proto_rawDescGZIP(), []int{2}
}

func (x *IpInfoResp) GetData() []*IpInfo {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_proxy_v1_ip_proto_rawDesc = []byte{
	...
	0x22, 0x32, 0x0a, 0x0a, 0x49, 0x70, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x73, 0x70, 0x12, 0x24,
	0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x70,
	0x72, 0x6f, 0x78, 0x79, 0x2e, 0x76, 0x31, 0x2e, 0x49, 0x70, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x04,
	0x64, 0x61, 0x74, 0x61, 0x42, 0x8f, 0x01, 0x0a, 0x0c, 0x63, 0x6f, 0x6d, 0x2e, 0x70, 0x72, 0x6f,
	0x78, 0x79, 0x2e, 0x76, 0x31, 0x42, 0x07, 0x49, 0x70, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x48, 0x02,
...
var file_proxy_v1_ip_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_proxy_v1_ip_proto_goTypes = []interface{}{
	(*ServicePort)(nil), // 0: proxy.v1.ServicePort
	(*IpInfo)(nil),      // 1: proxy.v1.IpInfo
	(*IpInfoResp)(nil),  // 2: proxy.v1.IpInfoResp
}
var file_proxy_v1_ip_proto_depIdxs = []int32{
	1, // 0: proxy.v1.IpInfoResp.data:type_name -> proxy.v1.IpInfo
...
func file_proxy_v1_ip_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proxy_v1_ip_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
